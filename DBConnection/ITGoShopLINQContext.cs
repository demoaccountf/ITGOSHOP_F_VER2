...
namespace ITGoShop_F_Ver2.Models
{
    ...
    {
        private const string connectionString = "itgs.mysql.database.azure.com;port=3306;database=itgoshop;user id=itgs;password=c@123456;Convert Zero Datetime=True";
